...
# 📖 SQL Clinic <a name="about-project"></a>

 This is a repository that includes data to create a table of patient, created from a diagram.
...
cd my-folder
git clone https://github.com/sebalp100/sql-table-from-diagram/
...
- Use the code from schema_based_on_diagram.sql to create a new database
